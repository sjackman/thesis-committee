...
2. Message passing is slow
3. Network communication is really slow
...
![Human: 42 Mbp scaffold NG50 with BioNano optical mapping](images/abyss2-ideogram.png){height=600px}
...
- ARCS improved NGA50 from 3 to 8 Mbp
...
- 2.04 Mbp scaffold N50 with ARCS
- 2.31 Mbp scaffold N50 with Tigmint + ARCS
- Tigmint improved N50 by 14% over ARCS alone
...
5. ORCA <small>(in press)</small>
6. Organellar genomes of white spruce <small>([doi.org/f8bxck](https://doi.org/f8bxck))</small>
7. Mitochondrial genome of Sitka spruce <small>([doi.org/10.1101/601104](https://doi.org/10.1101/601104))</small>
8. **Genome assembly of western redcedar**
9. Conclusion
