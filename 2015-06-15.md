...
[Nanopolish][] | DALIGNER | POA      | Celera  | Nanopolish
...
+ Annotated protein-coding genes (mRNA)
+ Annotated non-coding genes (rRNA and tRNA)
+ Annotated repeats
...
+ Analyse RNA-seq data
    + Annotate introns of ORFs
    + Identify sites of C to U RNA editing
