...
- Fourth committee meeting 2018-01-30
...
- 7 lanes of Oxford Nanopore Sequencing
- ~ 1x nuclear coverage
- &gt; 10x mitochondrial coverage
- Assemble Nanopore reads
- Scaffold and polish with linked reads

------------------------------------------------------------

![Nanopore reads assembled with Miniasm](images/sitka-spruce-mt-miniasm.png)
